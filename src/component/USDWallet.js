...
export default class USDWallet extends React.Component {
    render(){
        return (
            <View style={styles.container}>
                ...
                <View style = {{height: '10%', backgroundColor: '#263238',}}>
                    <View style = {{ marginTop: 15, height: '15%', justifyContent: 'space-between', flexDirection: 'row' }}>
                        ...
                        <View style = {{marginTop: 5}}>
                            <Text style = {{fontSize: 20, fontWeight: 'bold', color: '#fff'}}>USD Wallet</Text>
                        </View>
                        <View style = {{marginRight: 20, marginTop: 7}}>
                            <Text style = {{fontSize: 15, color: '#fff'}} onPress={()=>{this.props.navigation.navigate('home')}}>Deposit</Text>
                        </View>
                    </View>
                </View>
                ...
                <View style = {{ justifyContent: 'center', alignItems: 'center', marginTop: 50}}>
                    ...
                    <View style = {{flexDirection: 'row',  justifyContent: 'center', alignItems: 'center',  marginTop: 5 }}> 
                        <Text style = {{fontSize: 30, fontWeight: 'bold', color: '#fff',}}>423.020000 USD</Text>
                    </View>
                </View>
                    ...
                    <TouchableOpacity style = {{backgroundColor: '#263238', height: 70, justifyContent: 'center', marginTop: 3, marginBottom: 3, marginLeft: 20, marginRight: 20, borderRadius: 5}}>
                        <View style = {{flexDirection: 'row'}}>
                            <View style = {{ marginLeft: 15, justifyContent:'center',}}>
                                <Image source = {require('./../image/Logo2.png')} style = {{width: 50, height: 50}}/>
