...
export default class OrderSell extends React.Component {
    render(){
        return (
            <View style={styles.container}>
                ...
                <View style = {{height: '10%', backgroundColor: '#263238',}}>
                    <View style = {{ marginTop: 15,  flexDirection: 'row' }}>
                        ...
                        <View style = {{marginTop: 5, }}>
                            <Text style = {{fontSize: 20, marginLeft: 75, fontWeight: 'bold', color: '#fff'}}>Sell Order</Text>
                        </View>
                    </View>
                </View>
                ...
                <View style = {{ alignItems: 'center'}}>
                    <View style = {{width: 250,   marginTop: 40, marginBottom: 40 }}>
                        ...
                        <Text style={{ fontWeight: 'bold', marginVertical: 10, alignSelf: 'center', fontSize: 18, fontSize: 20,  color: '#FFA726'}}>SELL</Text>
                        </View>
                        </TouchableOpacity>
                    </View>
                </View>
